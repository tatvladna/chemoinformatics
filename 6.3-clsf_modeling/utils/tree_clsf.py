...
output_folder="../tree_clsf"
os.makedirs(output_folder, exist_ok=True)

model = DecisionTreeClassifier()

param_grid = {'max_depth': np.arange(10, 75, 5)}
...
txt_path = os.path.join(output_folder, 'tree_clsf.txt')
csv_path = os.path.join(output_folder, 'tree_clsf.csv')
